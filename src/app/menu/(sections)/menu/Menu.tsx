        ...
        <div className="fixed left-0 top-0 z-50 flex w-full flex-col gap-4 bg-background pb-2 pt-3 md:sticky md:gap-2 md:pt-2">
          <div className="flex w-full items-center justify-between gap-4">
            <div className="flex w-full gap-2 pr-4 md:pr-0">
              <div
                className="flex items-center justify-center bg-white md:hidden"
                onClick={() => router.back()}
              >
            ...
            <Button
              className="hidden items-center gap-2 px-6 py-6 font-semibold text-white md:flex"
              asChild
            >
            ...
            {menuCategory?.map((item) => {
              return (
                <button
                  ...
                  className={cn(
                    "w-fit border-b-2 border-b-transparent bg-primary px-6 py-4 font-semibold text-black transition-all duration-300 ease-in-out md:bg-transparent",
