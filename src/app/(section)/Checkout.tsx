  ...
  return (
    <section className="flex h-full w-full flex-col gap-8 py-16">
      <div className="flex flex-col gap-2">
        <h3 className="text-center font-montserrat text-xl font-semibold uppercase tracking-[3.2px] text-black md:text-3xl">
      ...
      <div className="flex h-full w-full items-center justify-center">
        <div className="mx-4 flex h-full w-full max-w-[1300px] flex-col items-center justify-center gap-6 py-12 md:flex-row md:gap-16 md:py-20">
